...
The server should now be running in localhost. It should return the index.html page. Press the key combination "CTRL+C" to interrupt it. If it is not the first time running the server, follow only from point 3) to point 6).
